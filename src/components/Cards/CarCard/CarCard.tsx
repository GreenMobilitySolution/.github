...
import { CarCardProps } from '../../../../lib/Car/CarProp';
import StarRating from '../../rating/StarRating';
import GreenButton from '../../Buttons/GreenButton';

const CarCard: React.FC<CarCardProps> = ({ name, model, imageUrl, description, owner, rating }) => {
    ...
    >
      ...
      <div className="px-6 py-4">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="font-medium text-xl mb-2"> {name} {model}</h1>
