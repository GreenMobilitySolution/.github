    ...
    <div className="w-64 bg-white shadow-md h-full fixed top-24 left-0 p-4 overflow-y-auto">
      <div className="p-4">
        ...
        <nav className="flex flex-col gap-4">
          <NavItem to="overview" icon={<BarChart className="w-6 h-6" />} label="Overview" />
          <NavItem to="fleet-management" icon={<Truck className="w-6 h-6" />} label="Vehicles" />
          <NavItem to="routes-management" icon={<Map className="w-6 h-6" />} label="Routes" />
          <NavItem to="employee-management" icon={<Users className="w-6 h-6" />} label="Employee" />
          <NavItem to="finance-management" icon={<DollarSign className="w-6 h-6" />} label="Finance" />
          <NavItem to="manager-payment" icon={<CreditCard className="w-6 h-6" />} label="Payments" />
          <NavItem to="manager-reimburse" icon={<RefreshCw className="w-6 h-6" />} label="Reimburse" />
          <NavItem to="inbox" icon={<Inbox className="w-6 h-6" />} label="Inbox" />
          <NavItem to="manager-bookings" icon={<Calendar className="w-6 h-6" />} label="Bookings" />
